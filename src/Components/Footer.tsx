        ...
        <div className="footer-top">
          ...
          <div className="footer-column footer-brand">
            ...
            <div className="footer-social">
              <a
                href="https://instagram.com/lifeaidstore"
                target="_blank"
              ...
              <a
                href="https://wa.me/6281219751605"
                target="_blank"
                rel="noopener noreferrer"
                className="footer-social-link"
          ...
          <div className="footer-column footer-contact">
            ...
            <div className="footer-contact-item">
              ...
              <a href={`mailto:${t.contact.email}`} className="footer-contact-link">
                {t.contact.email}
              </a>
            </div>
            ...
            <div className="footer-contact-item">
              ...
              <a href={`tel:${t.contact.phone}`} className="footer-contact-link">
                {t.contact.phone}
              </a>
            </div>
          </div>
