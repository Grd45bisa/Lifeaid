            ...
            <div className="settings-form">
                <section className="settings-section">
                    ...
                    <div className="form-group">
                        <label htmlFor="settings-whatsapp">{t.settings.whatsapp[lang]}</label>
                        <input id="settings-whatsapp" type="text" value={formData.whatsapp} onChange={(e) => handleChange('whatsapp', e.target.value)} placeholder="628123456789" />
                        <small>{lang === 'id' ? 'Contoh: 628123456789 (tanpa + atau spasi)' : 'Example: 628123456789 (without + or spaces)'}</small>
                    </div>
                    <div className="form-group">
                        <label htmlFor="settings-email">{t.settings.email[lang]}</label>
                        <input id="settings-email" type="email" value={formData.email} onChange={(e) => handleChange('email', e.target.value)} placeholder="contact@lifeaid.com" />
                    </div>
                    <div className="form-group">
                        <label htmlFor="settings-phone">{t.settings.phone[lang]}</label>
                        <input id="settings-phone" type="text" value={formData.phone} onChange={(e) => handleChange('phone', e.target.value)} placeholder="021-1234567" />
                    </div>
                    <div className="form-group">
                        <label htmlFor="settings-address">{t.settings.address[lang]}</label>
                        <textarea id="settings-address" value={formData.address} onChange={(e) => handleChange('address', e.target.value)} rows={3} placeholder={lang === 'id' ? 'Alamat lengkap toko' : 'Full store address'} />
                    </div>
                </section>
                ...
                <section className="settings-section">
                    ...
                    <div className="form-group">
                        <label htmlFor="settings-tokopedia">{t.settings.tokopedia[lang]}</label>
                        <input id="settings-tokopedia" type="url" value={formData.tokopedia} onChange={(e) => handleChange('tokopedia', e.target.value)} placeholder="https://tokopedia.com/..." />
                    </div>
                    <div className="form-group">
                        <label htmlFor="settings-shopee">{t.settings.shopee[lang]}</label>
                        <input id="settings-shopee" type="url" value={formData.shopee} onChange={(e) => handleChange('shopee', e.target.value)} placeholder="https://shopee.co.id/..." />
                    </div>
                </section>
                ...
                <section className="settings-section">
                    ...
                    <div className="form-group">
                        ...
                        <input id="settings-instagram" type="url" value={formData.instagram} onChange={(e) => handleChange('instagram', e.target.value)} placeholder="https://instagram.com/..." />
                    </div>
                    <div className="form-group">
                        <label htmlFor="settings-facebook">Facebook</label>
                        <input id="settings-facebook" type="url" value={formData.facebook} onChange={(e) => handleChange('facebook', e.target.value)} placeholder="https://facebook.com/..." />
                    </div>
                </section>
                ...
                <section className="settings-section">
                    ...
                    <div className="form-group toggle-group">
                        ...
                        <label htmlFor="settings-use-db" className="toggle-switch">
                            <input
                                id="settings-use-db"
                                type="checkbox"
